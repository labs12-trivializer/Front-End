...
export const UPGRADE_TIER_START = 'UPGRADE_TIER_START';
export const UPGRADE_TIER_SUCCESS = 'UPGRADE_TIER_SUCCESS';
export const UPGRADE_TIER_FAILURE = 'UPGRADE_TIER_FAILURE';
export const CREATE_TOKEN_SUCESS = 'CREATE_TOKEN_SUCESS';
export const SUBSCRIBE_CUSTOMER_SUCCESS = 'SUBSCRIBE_CUSTOMER_SUCCESS';
...
// STATE QUESTIONS (questions only in our redux state)
export const DELETE_STATE_QUESTION = 'DELETE_STATE_QUESTION';

// Question Swapping
export const CHANGE_QUESTION_START = 'CHANGE_QUESTION_START';
export const CHANGE_QUESTION_SUCCESS = 'CHANGE_QUESTION_SUCCESS';
export const CHANGE_QUESTION_FAILURE = 'CHANGE_QUESTION_FAILURE';
